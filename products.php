...
<html>
    <head>
        ...
        <title>Vivek Vishakha Online Store</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to Vivek Vishakha Online Store!</h1>
           ...
           <footer class="footer">
               <div class="container">
                <center>
                <p>Copyright &copy <a href="https://github.com/agrawalvivek2017">VIVEK AGRAWAL</a>. All Rights Reserved.</p>
                   <p>Made with &lt3 in VIT </p>
               </center>
               </div>
           </footer>
        </div>
